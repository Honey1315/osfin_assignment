...
const Confirmation  : React.FC= () => {
  return (
    <div>
        <div className="w-max p-6 mx-auto text-center mt-[4rem] bg-white rounded-lg shadow-sm">
      <div>
        {/* Success Icon */}
        <div className="mx-auto mb-4 w-16 h-16 flex items-center justify-center">
          <img src="/assets/svgs/Vector.svg" alt="Success Icon" className="w-10 h-10" />
        </div>

        {/* Main Message */}
        <h2 className="text-xl font-semibold text-[#31A91D] text-900 mb-2">
          Congratulations! You have successfully booked tickets
        </h2>

        {/* Additional Information */}
        <p className="text-sm text-600 text-[#808080] mt-4 text-center">
          Please carry ERS / VRM / SMS / Mail sent to your contact details, 
          along with a relevant ID proof while travelling
        </p>
      </div>
    </div>
    <div className="w-full m-6 p-6 bg-white rounded-lg shadow-sm border border-gray-200">
      {/* Header Section */}
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          <h3 className="font-medium text-900">Airbus A350-900</h3>
        </div>
        ...
        <div className="flex whitespace-nowrap flex-row flex-nowrap content-center justify-between text-700 my-6">
            ...
            <div className="flex flex-col items-center w-full">
                <div className="text-gray-700">2 hours 20 minutes</div>
